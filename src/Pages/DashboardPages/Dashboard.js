...
const Dashboard = () => {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const response = await fetch("http://http://34.131.12.7/auth/admins", {
          method: "GET",
          headers: {
            Accept: "*/*",
  ...
  const handleAddAdmin = async (e) => {
    ...
    const response = await fetch("http://http://34.131.12.7/auth/signup", {
      method: "POST",
      body: bodyContent,
      headers: headersList,
    });
  ...
  const handleDeleteAdmin = async (e) => {
    ...
    const response = await fetch("http://http://34.131.12.7/auth/deleteuser", {
      method: "POST",
      body: bodyContent,
      headers: headersList,
    });
